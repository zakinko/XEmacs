...
(defun x-font-create-object (fontname &optional device)
  ...
  (let ((case-fold-search t))
	...
	(if (equal "*" weight)  (setq weight  nil))
	(if (equal "*" slant)   (setq slant   nil))
	(if (equal "*" swidth)  (setq swidth  nil))
	(if (equal "*" adstyle) (setq adstyle nil))
	(if (equal "*" pxsize)  (setq pxsize  nil))
	(if (equal "*" ptsize)  (setq ptsize  nil))
